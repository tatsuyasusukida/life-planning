...
| 配偶者の生年月日 | string | | 配偶者の生年月日（ISO 8601形式: YYYY-MM-DD） |
| 配偶者の年収 | number | | 配偶者の年収（円） |
| 子供の情報 | array | | 子供の情報の配列 |
| 子供の情報[].生年月日 | string | ✓ | 子供の生年月日（ISO 8601形式: YYYY-MM-DD） |
...
| 配偶者の年齢 | number | 配偶者のその年の1月1日時点での満年齢（配偶者情報がある場合のみ） |
| 子供の情報 | array | 子供の情報の配列（子供の情報がある場合のみ） |
| 子供の情報[].年齢 | number | 子供のその年の1月1日時点での満年齢 |
...
| 健康保険料月額 | number | 健康保険料月額（従業員負担分、円） |
| 介護保険料月額 | number | 介護保険料月額（従業員負担分、円） |
| 厚生年金保険料月額 | number | 厚生年金保険料月額（従業員負担分、円） |
| 社会保険料月額 | number | 社会保険料月額合計（健康保険料+介護保険料+厚生年金保険料、円） |
| 社会保険料年額 | number | 社会保険料年額（社会保険料月額×12ヶ月、円） |
